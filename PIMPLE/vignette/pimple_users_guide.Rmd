...
Performance Indicators and Management Procedures (PIMPLE) is a tool for exploring and comparing the relative performance of alternative candidate harvest control rules (HCRs).
...
**The HCRs** tab shows the shapes of the different candidate HCRs and which parts of the HCR were active during the evaluations; **PI Inspector** allows detailed inspection of each type of PI and metric; **Comparing MPs** allows HCRs to be compared across the full range of PIs.
...
For more information on these plot types see the *Comparing MPs* section later on.
...
This tab has a time series plot of relative CPUE as well a bar chart and box plot of the average relative CPUE in the different time periods.

## PI 6: Catch stability

The catch stability through time is presented either as the variability and the stability (PI 6).
...
Several individual trajectories (known as worms or spaghetti) are shown as illustrations.
