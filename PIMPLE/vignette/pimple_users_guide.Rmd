...
\scriptsize
  \begin{tabularx}{\linewidth}{|p{0.03\linewidth}|p{0.1\linewidth}|X|X|}
    ...
    \hline
        4 & Economic    & Maintain acceptable CPUE & CPUE relative to the CPUE in 2010\\
    \hline
...
## Indicator 4. CPUE relative to the CPUE in 2010

This indicator is linked to the objective: Maintain acceptable CPUE.
It is based on the predicted skipjack CPUE relative to the CPUE in reference period levels. Here, the reference period level is taken to be 2010.
...
The absolute annual difference of the effort relative to the base effort in 2010 is calculated for each replicate in each year. 
