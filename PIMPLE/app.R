...
ui <- navbarPage(id="top",
  ...
  # First panel is results - has a sidepanel for all subtabs
  tabPanel(title="Results", value="results",
    sidebarLayout(
      sidebarPanel(width=3,
        ...
        br(),
        # Loads of mucking about with the side panel of the results tab
        # Add in HCR choice - shown in all results tabs
        ...
        conditionalPanel(condition="input.results == 'pis' || input.comptab == 'timeseries'",
          checkboxInput("showspag", "Show trajectories", value=FALSE) 
        ),
        # Add in PI and catch choice - only shown in the compare PIs tab
        ...
        # Add in catch choice - only in the catch and catch stability PI tabs
        conditionalPanel(condition="(input.pitab == 'pi3' || input.pitab == 'pi6' || input.results == 'compareMPs')",
      ...
      mainPanel(width=9,
        tabsetPanel(id="results",
          ...
          # The performance indicators tab also has a bunch of subtabs
          tabPanel("Performance indicators", value="pis",
          ...
          # The comparing performance tab also has a bunch of subtabs
          tabPanel(title="Comparing performance", value="compareMPs",
  ...
  # Notes tab has the same layout with sidepanel
  ...
  # About tab has the same layout with sidepanel
