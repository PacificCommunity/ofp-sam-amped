...
ui <- fluidPage(id="top",
  ...
  sidebarLayout(
    ...
    sidebarPanel(width=2,
      ...
      conditionalPanel(condition="input.everything == 'compareMPs' ||input.everything == 'explorePIs' || input.everything == 'hcrs'",
      ...
      conditionalPanel(condition="input.everything == 'compareMPs'",
      ...
      conditionalPanel(condition="input.everything == 'explorePIs' || input.comptab == 'timeseries'",
        checkboxInput("showspag", "Show trajectories", value=FALSE) 
      ),
      # Catch choice - only in the catch and catch stability PI tabs
      conditionalPanel(condition="(input.everything == 'compareMPs' || input.pitab == 'pi3' || input.pitab == 'pi6')",
    ...
    #mainPanel(width=9,
    mainPanel(width=10,
    # tabPanel with a sidebar and a main layout
    # 5 tabs - Comparing performance, Detailed exploration, HCRs, Notes, About
      tabsetPanel(id="everything",
        # ------------------ Introduction -----------------------
        tabPanel(title="Introduction", value="notes",
          h1("PIMPLE"),
