...
The question is, which HCR of these three is the best one?
...
As the HCR uses the estimate of SB/SBF=0 to set the catch limit, it means that the catch limit set by the HCR also bounces around. This then goes onto affect the stock and so on.
