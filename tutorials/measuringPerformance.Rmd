...
The more iterations (number of projections) we had, the more stable the histograms were and the better the estimate of uncertainty in the PIs.
...
It is generally thought that the higher the value of *Prob. SB > LRP*, *Catch* and *CPUE (rel. 2018)* the better the HCR is performing.

However, for *Effort (rel. 2018)* and the three *variability* PIs, lower values are preferred. High effort implies high costs (something we want to avoid).
