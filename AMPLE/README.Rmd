...
Alternatively, you can get the latest version from the GitHub repository [here](https://github.com/PacificCommunity/ofp-sam-amped/tree/master/AMPLE) by installing it with the *devtools* package.
