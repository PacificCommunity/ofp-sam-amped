...
During these evaluations the performance is measured using a collection of indicators, known as performance indicators (PIs).
...
Repeat the above process (set up the HCR, run the projection, add to the basket) two more HCRs.
...
This might not look as pretty, but can be very useful for really digging down into the results, particularly if you have narrowed your choices to just a few HCRs.
